...
/*
    ...
    void Start()
    {
        StartCoroutine(GetRequest("https://dinomight.herokuapp.com/GetData.php"));
...
*/
    ...
    public IEnumerator Registration(string username, string password)
    {
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://dinomight.herokuapp.com/Registration.php", form))
        {
            yield return www.SendWebRequest();
