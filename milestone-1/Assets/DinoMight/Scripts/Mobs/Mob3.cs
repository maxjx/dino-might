...
public class Mob3 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Vector2 playertf = player.transform.position;
        Vector2 distanceFromPlayer = currPos - playertf;
        float sqDisplacementFromPlayer = distanceFromPlayer.sqrMagnitude;
        bool playerInRange = (sqDisplacementFromPlayer < attackPlayerRange * attackPlayerRange) && (playertf.y < currPos.y);
